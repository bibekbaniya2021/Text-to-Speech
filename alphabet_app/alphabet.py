...
str1 = StringVar()
str1.set('Welcome to "Text-to-Speech" Programming')
frame1 = Frame(root, bg='white')
frame1.grid()

Disp = Canvas(frame1, width=160,height=120,bg='white')
Disp.grid(row=1,column=3)
img = PhotoImage(file='text-to-speech2.png')
image = Disp.create_image(85,62,image = img)

imgClear = PhotoImage(file='text-to-speech2.png')
def Clear():
    str1.set('Welcome to "Text-to-Speech" Programming')
    Disp.create_image(85,62,image = imgClear)
    engine.say('Welcome to "Text-to-Speech" Programming')
    engine.runAndWait()
...
imgI = PhotoImage(file='itsapalm.png')
def Alphabet_I():
    str1.set("I is for It's a palm")
    Disp.create_image(85,62,image=imgI)
    engine.say("I is for It's a palm")
    engine.runAndWait()
...
#===========================Row 2===============================
btnG=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_G,width=10,height=3,text='G',bg='orange',fg='white')\
    .grid(row=2,column=0)
btnH=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_H,width=10,height=3,text='H',bg='blue',fg='white')\
    .grid(row=2,column=1)
btnI=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_I,width=10,height=3,text='I',bg='blue',fg='white')\
    .grid(row=2,column=2)
btnJ=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_J,width=10,height=3,text='J',bg='blue',fg='white')\
    .grid(row=2,column=3)
btnK=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_K,width=10,height=3,text='K',bg='blue',fg='white')\
    .grid(row=2,column=4)
btnL=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_L,width=10,height=3,text='L',bg='blue',fg='white')\
    .grid(row=2,column=5)
btnM=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_M,width=10,height=3,text='M',bg='orange',fg='white')\
    .grid(row=2,column=6)

#============================Row 3================================
btnN=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_N,width=10,height=3,text='N',bg='orange',fg='white')\
    .grid(row=3,column=0)
btnO=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_O,width=10,height=3,text='O',bg='blue',fg='white')\
    .grid(row=3,column=1)
btnP=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_P,width=10,height=3,text='P',bg='blue',fg='white')\
    .grid(row=3,column=2)
btnQ=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_Q,width=10,height=3,text='Q',bg='blue',fg='white')\
    .grid(row=3,column=3)
btnR=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_R,width=10,height=3,text='R',bg='blue',fg='white')\
    .grid(row=3,column=4)
btnS=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_S,width=10,height=3,text='S',bg='blue',fg='white')\
    .grid(row=3,column=5)
btnT=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_T,width=10,height=3,text='T',bg='orange',fg='white')\
    .grid(row=3,column=6)

#============================Row 4================================
btnU=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_U,width=10,height=3,text='U',bg='orange',fg='white')\
    .grid(row=4,column=0)
btnV=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_V,width=10,height=3,text='V',bg='orange',fg='white')\
    .grid(row=4,column=1)
btnW=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_W,width=10,height=3,text='W',bg='orange',fg='white')\
    .grid(row=4,column=2)
btnX=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_X,width=10,height=3,text='X',bg='orange',fg='white')\
    .grid(row=4,column=4)
btnY=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_Y,width=10,height=3,text='Y',bg='orange',fg='white')\
    .grid(row=4,column=5)
btnZ=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_Z,width=10,height=3,text='Z',bg='orange',fg='white')\
    .grid(row=4,column=6)
btnClear=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Clear,width=10,height=3,text='Reset',bg='green',fg='white')\
    .grid(row=4,column=3)
